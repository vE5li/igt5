...
impl Data {
    ...
    pub fn bigger(&self, source: &Data) -> Status<bool> {
        match self {

            Data::Map(map) => {
                match source {
                    Data::Integer(source_value) => return success!(map.len() as i64 > *source_value),
                    Data::Character(source_value) => return success!(map.len() > (source_value.code() as usize)),
                    Data::Float(source_value) => return success!((map.len() as f64) > *source_value),
                    Data::Map(source_map) => return success!(map.len() > source_map.len()),
                    Data::List(source_items) => return success!(map.len() > source_items.len()),
                    Data::Path(source_steps) => return success!(map.len() > source_steps.len()),
                    Data::String(source_string) => return success!(map.len() > source_string.len()),
                    Data::Identifier(source_identifier) => return success!(map.len() > source_identifier.len()),
                    Data::Keyword(source_keyword) => return success!(map.len() > source_keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }

            Data::List(items) => {
                match source {
                    Data::Integer(source_value) => return success!(items.len() as i64 > *source_value),
                    Data::Character(source_value) => return success!(items.len() > (source_value.code() as usize)),
                    Data::Float(source_value) => return success!((items.len() as f64) > *source_value),
                    Data::Map(source_map) => return success!(items.len() > source_map.len()),
                    Data::List(source_items) => return success!(items.len() > source_items.len()),
                    Data::Path(source_steps) => return success!(items.len() > source_steps.len()),
                    Data::String(source_string) => return success!(items.len() > source_string.len()),
                    Data::Identifier(source_identifier) => return success!(items.len() > source_identifier.len()),
                    Data::Keyword(source_keyword) => return success!(items.len() > source_keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::Path(steps) => {
                match source {
                    Data::Integer(source_value) => return success!(steps.len() as i64 > *source_value),
                    Data::Character(source_value) => return success!(steps.len() > (source_value.code() as usize)),
                    Data::Float(source_value) => return success!((steps.len() as f64) > *source_value),
                    Data::Map(source_map) => return success!(steps.len() > source_map.len()),
                    Data::List(source_items) => return success!(steps.len() > source_items.len()),
                    Data::Path(source_steps) => return success!(steps.len() > source_steps.len()),
                    Data::String(source_string) => return success!(steps.len() > source_string.len()),
                    Data::Identifier(source_identifier) => return success!(steps.len() > source_identifier.len()),
                    Data::Keyword(source_keyword) => return success!(steps.len() > source_keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::String(string) => {
                match source {
                    Data::Integer(source_value) => return success!(string.len() as i64 > *source_value),
                    Data::Character(source_value) => return success!(string.len() > (source_value.code() as usize)),
                    Data::Float(source_value) => return success!((string.len() as f64) > *source_value),
                    Data::Map(source_map) => return success!(string.len() > source_map.len()),
                    Data::List(source_items) => return success!(string.len() > source_items.len()),
                    Data::Path(source_steps) => return success!(string.len() > source_steps.len()),
                    Data::String(source_string) => return success!(string.len() > source_string.len()),
                    Data::Identifier(source_identifier) => return success!(string.len() > source_identifier.len()),
                    Data::Keyword(source_keyword) => return success!(string.len() > source_keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::Identifier(identifier) => {
                match source {
                    Data::Integer(source_value) => return success!(identifier.len() as i64 > *source_value),
                    Data::Character(source_value) => return success!(identifier.len() > (source_value.code() as usize)),
                    Data::Float(source_value) => return success!((identifier.len() as f64) > *source_value),
                    Data::Map(source_map) => return success!(identifier.len() > source_map.len()),
                    Data::List(source_items) => return success!(identifier.len() > source_items.len()),
                    Data::Path(source_steps) => return success!(identifier.len() > source_steps.len()),
                    Data::String(source_string) => return success!(identifier.len() > source_string.len()),
                    Data::Identifier(source_identifier) => return success!(identifier.len() > source_identifier.len()),
                    Data::Keyword(source_keyword) => return success!(identifier.len() > source_keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::Keyword(keyword) => {
                match source {
                    Data::Integer(source_value) => return success!(keyword.len() as i64 > *source_value),
                    Data::Character(source_value) => return success!(keyword.len() > (source_value.code() as usize)),
                    Data::Float(source_value) => return success!((keyword.len() as f64) > *source_value),
                    Data::Map(source_map) => return success!(keyword.len() > source_map.len()),
                    Data::List(source_items) => return success!(keyword.len() > source_items.len()),
                    Data::Path(source_steps) => return success!(keyword.len() > source_steps.len()),
                    Data::String(source_string) => return success!(keyword.len() > source_string.len()),
                    Data::Identifier(source_identifier) => return success!(keyword.len() > source_identifier.len()),
                    Data::Keyword(source_keyword) => return success!(keyword.len() > source_keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::Integer(self_value) => {
                match source {
                    Data::Integer(source_value) => return success!(*self_value > *source_value),
                    Data::Character(source_value) => return success!(*self_value > (source_value.code() as i64)),
                    Data::Float(source_value) => return success!((*self_value as f64) > *source_value),
                    Data::Map(map) => return success!(*self_value > map.len() as i64),
                    Data::List(items) => return success!(*self_value > items.len() as i64),
                    Data::Path(steps) => return success!(*self_value > steps.len() as i64),
                    Data::String(string) => return success!(*self_value > string.len() as i64),
                    Data::Identifier(identifier) => return success!(*self_value > identifier.len() as i64),
                    Data::Keyword(keyword) => return success!(*self_value > keyword.len() as i64),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::Character(self_value) => {
                match source {
                    Data::Integer(source_value) => return success!((self_value.code() as i64) > *source_value),
                    Data::Character(source_value) => return success!((self_value.code() as i64) > (source_value.code() as i64)),
                    Data::Float(source_value) => return success!((self_value.code() as i64 as f64) > *source_value),
                    Data::Map(map) => return success!((self_value.code() as usize) > map.len()),
                    Data::List(items) => return success!((self_value.code() as usize) > items.len()),
                    Data::Path(steps) => return success!((self_value.code() as usize) > steps.len()),
                    Data::String(string) => return success!((self_value.code() as usize) > string.len()),
                    Data::Identifier(identifier) => return success!((self_value.code() as usize) > identifier.len()),
                    Data::Keyword(keyword) => return success!((self_value.code() as usize) > keyword.len()),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
            ...
            Data::Float(self_value) => {
                match source {
                    Data::Integer(source_value) => return success!(*self_value > (*source_value as f64)),
                    Data::Character(source_value) => return success!(*self_value > (source_value.code() as i64 as f64)),
                    Data::Float(source_value) => return success!(*self_value > *source_value),
                    Data::Map(map) => return success!(*self_value > (map.len() as f64)),
                    Data::List(items) => return success!(*self_value > (items.len() as f64)),
                    Data::Path(steps) => return success!(*self_value > (steps.len() as f64)),
                    Data::String(string) => return success!(*self_value > (string.len() as f64)),
                    Data::Identifier(identifier) => return success!(*self_value > (identifier.len() as f64)),
                    Data::Keyword(keyword) => return success!(*self_value > (keyword.len() as f64)),
                    Data::Boolean(..) => error!(Message, string!(str, "booleans may not be comapred by size")),
                }
            }
    ...
    pub fn smaller(&self, source: &Data) -> Status<bool> {
        match self {
