...
pub enum Piece {
    ...
    Keyword(Option<Data>, Vec<AsciiString>),
    Operator(Option<Data>, Vec<AsciiString>),
    Identifier(Option<Data>, Vec<AsciiString>),
    TypeIdentifier(Option<Data>, Vec<AsciiString>),
    String(Option<Data>, Vec<AsciiString>),
